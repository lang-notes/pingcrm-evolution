  ...
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/products">
        <icon name="printer" class="mr-2 w-4 h-4" :class="isUrl('products') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('reports') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Products</div>
      </Link>
    </div>
    <div class="mb-4">
